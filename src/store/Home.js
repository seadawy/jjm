...
const Home = () => {
    ...
    return (<>
        ...
        <hr />
        {/* Statics */}
        <div className="bg-white dark:bg-slate-500 sm:py-9 ">
            <div className="mx-auto max-w-7xl px-6 lg:px-8 dark:text-white">
                <dl className="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-3 dark:text-white">
                    <div className="border-4 border-slate-800 py-6 px-12 shadow-2xl rounded-md mx-auto flex max-w-xs flex-col gap-y-4 hover:bg-slate-800 hover:text-white group">
                        <dt className="text-base leading-7 text-gray-600 dark:text-white group-hover:text-white">Successful Sale</dt>
                        <dd className="order-first text-3xl font-semibold dark:text-white tracking-tight text-gray-900 dark:group-hover:text-white sm:text-5xl">2k</dd>
                    </div>
                    <div className="border-4 border-slate-800 w-52 py-6 px-12 shadow-2xl rounded-md mx-auto flex max-w-xs flex-col gap-y-4 hover:bg-slate-800 hover:text-white group">
                        <dt className="text-base leading-7 text-gray-600 dark:text-white group-hover:text-white">Car Avaliable</dt>
                        <dd className="order-first text-3xl font-semibold dark:text-white  tracking-tight text-gray-900 dark:group-hover:text-white sm:text-5xl">200</dd>
                    </div>
                    <div className="border-4 border-slate-800 py-6 px-12 shadow-2xl rounded-md mx-auto flex max-w-xs flex-col gap-y-4 hover:bg-slate-800 hover:text-white group">
                        <dt className="text-base leading-7 text-gray-600 dark:text-white group-hover:text-white">Brand Avaliable</dt>
                        <dd className="order-first text-3xl font-semibold dark:text-white tracking-tight text-gray-900 dark:group-hover:text-white sm:text-5xl">12</dd>
                    </div>
                </dl>
            </div>
        </div>
        <hr />
        {/* Feature */}
        <div className="bg-gray-100 dark:bg-slate-600 py-24 sm:py-26 divide-y divide-dashed hover:divide-solid">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:text-center">
                    <h2 className="text-3xl py-4 font-semibold leading-7 text-indigo-600">Our Features</h2>
